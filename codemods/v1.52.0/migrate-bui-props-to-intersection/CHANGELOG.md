# @backstage/migrate-bui-props-to-intersection
...
- eeaf3d8: Add codemod to migrate ComboboxProps/SelectProps interface extends to type intersection for Backstage 1.52.0
